...
public class OmView extends MainViewmal {
    ...
    public OmView(PostService postService, PostRedigeringsomraade postRedigeringsomraade,
...
//TODO: Lag initierEntitet() i EntitetServiceMal som legger til ny UUID;

            kategoriService.initier(kategoriRedigeringsomraade);
            postService.initier(postRedigeringsomraade, kategoriService);
