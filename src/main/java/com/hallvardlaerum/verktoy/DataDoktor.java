...
public class DataDoktor {
    ...
    private void settInnUt(String datoString, String tekstFraBankenString, String beskrivelseString, Integer innInteger, Integer utInteger) {
        ...
        if (innInteger!=null && (post.getInnPaaKontoInteger()==null || !post.getInnPaaKontoInteger().equals(innInteger))) {
            skalEndres = true;
        }
        if (utInteger!=null && (post.getUtFraKontoInteger()==null || !post.getUtFraKontoInteger().equals(innInteger))) {
            skalEndres = true;
        }
