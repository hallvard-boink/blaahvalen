...
public class DataDoktor {
    ...
    public static void slettPeriodeposterMedKategoriType_SKAL_IKKE_KATEGORISERES() {
    ...
    //TODO: Denne skal testes!
    public void korrigerKonkretePoster() {
        ...
        byttKategori("2020-09-28", "26.09 JERNIA STADION SOGNSVN. 75 OSLO", "Andre planlagte utgifter");
        byttKategori("2019-08-15", "Skatt Betalt: 15.08.19", "Andre inntekter");
        byttInnUt("2022-07-13", "14.07 EXTRA TVERLANDE KVILUT 24 TVERLANDET");
        byttInnUt("2018-11-14", "*1686 13.11 NOK 736.00 RUTER AS - APP Kurs: 1.0000");
        byttkategoriAlle("2022-10-31", "28.10 Nokas Storo senter MB 2 0485 Oslo", "Overføring ut");
        fjernInnPaaKonto("2019-04-24", "Matildes forsikring Betalt: 24.04.19");
        byttInnUt("2018-03-12","Tilbakeføring Betalt: 10.03.18");
        byttKategori("2018-04-10", "Narvesen","Restaurant, kiosk og kafe");
        byttInnUt("2018-04-10", "Narvesen");
        fjernInnPaaKonto("2021-09-09","08.09 Nokas 7-Eleven Grefsen 0492 Oslo");
        byttKategori("2018-12-31","KREDITRENTER","Andre inntekter");
        byttKategori("2021-12-26","Til: Marek Lukaszewicz", "Porto og gebyrer");
        byttKategori("2018-06-04","Fra: Frances Emely Opsahl Taylor","Refusjon inn");
        fjernInnPaaKonto("2019-04-11","Fast sparebeløp Betalt: 11.04.19");
        fjernInnPaaKonto("2019-03-11","Fast sparebeløp Betalt: 11.03.19");
        byttKategori("2020-02-06", "*1854 05.02 NOK 75.00 HELTHJEM Kurs: 1.0000","Refusjon inn");
        byttKategori("2019-02-04","03.02 BUTIKKDRIFT HER GREFSENVEIEN OSLO","[Kategori ikke funnet - Ut]");

        byttKategori("2018-12-03","*1686 30.11 NOK 100.00 Vipps Kurs: 1.0000","[Kategori ikke funnet - Ut]");
        byttKategori("2018-12-19","Nettgiro til: 1503.41.11534 Betalt: 19.12.18","[Kategori ikke funnet - Ut]");
        byttKategori("2018-12-10","*1686 08.12 NOK 300.00 Vipps *Godt Og Hjemme Kurs: 1.0000","[Kategori ikke funnet - Ut]");
        byttKategori("2018-12-13","12.12 TORGGATA FRUKT TORGGT. 21 OSLO","[Kategori ikke funnet - Ut]");
        byttKategori("2018-12-20","19.12 NEDRE LØKKA THORVALD MEY OSLO","[Kategori ikke funnet - Ut]");
        byttKategori("2018-12-10","08.12 Bakken Øvre Går BAKKEN ØVRE LØTEN","[Kategori ikke funnet - Ut]");
        byttKategori("2018-12-12","Nettgiro til: 6129.06.31962 Betalt: 12.12.18","[Kategori ikke funnet - Ut]");

        byttKategori("2018-11-02","01.11 POINT 5019014 OSL LUFTHAVN GARDERMOEN","[Kategori ikke funnet - Ut]");
        byttKategori("2018-11-02","*1686 30.10 NOK 300.00 Vipps *Engebraaten Bo Kurs: 1.0000","[Kategori ikke funnet - Ut]");
        byttKategori("2018-11-07","06.11 777 FLESLAND GLADENGVEIEN OSLO","[Kategori ikke funnet - Ut]");
        byttKategori("2018-11-12","10.11 ARK, LINDERUD ERICH MOGENS OSLO","[Kategori ikke funnet - Ut]");
        byttKategori("2018-11-13","*1686 09.11 NOK 402.50 Pervaco AS Kurs: 1.0000","[Kategori ikke funnet - Ut]");

        byttKategori("2018-10-05","04.10 MARITA BRUKTHAN MARKVEIEN 67 OSLO","[Kategori ikke funnet - Ut]");
        byttKategori("2018-10-08","*1686 02.10 NOK 24.00 ULLEVAL SYKEHUS Kurs: 1.0000","[Kategori ikke funnet - Ut]");
        byttKategori("2018-10-15","Nettgiro til: 1214.36.85320 Betalt: 15.10.18","[Kategori ikke funnet - Ut]");
        byttKategori("2018-10-15","14.10 11005 SENTRUM P C.J.HAMBROS OSLO","[Kategori ikke funnet - Ut]");
        byttKategori("2018-10-23","*1686 20.10 SEK 49.86 Wirelane Sweden Kurs: 0.9340","[Kategori ikke funnet - Ut]");
        byttKategori("2018-10-23","*9926 20.10 SEK 500.00 BANKOMAT Kopcentrum N Kurs: 0.9341","[Kategori ikke funnet - Ut]");
        byttKategori("2018-10-23","*1686 20.10 SEK 0.03 Wirelane Sweden Kurs: 1.0000","[Kategori ikke funnet - Ut]");

        byttKategori("2018-07-02","Nettgiro til: 1506.08.80864 Betalt: 01.07.18","[Kategori ikke funnet - Ut]");
        byttKategori("2018-07-03","*1686 30.06 SEK 158.90 OOB NORDBY 193 Kurs: 0.9298","[Kategori ikke funnet - Ut]");
        byttKategori("2018-07-16","16.07 BLG SANDAKER SE SANDAKERVEIE OSLO","[Kategori ikke funnet - Ut]");
        byttKategori("2018-07-16","Nettgiro til: 1654.10.82755 Betalt: 16.07.18","[Kategori ikke funnet - Ut]");
        byttKategori("2018-08-02","*1686 29.07 NOK 75.00 KINGWINN AS Kurs: 1.0000","[Kategori ikke funnet - Ut]");
        byttKategori("2018-08-10","Nettgiro til: 1150.10.34535 Betalt: 10.08.18","[Kategori ikke funnet - Ut]");
        byttKategori("2018-08-14","13.08 MATKROKEN . TRONES","[Kategori ikke funnet - Ut]");
        byttKategori("2018-09-04","04.09 NORLI UNIVERSIT UNIVERSITETS OSLO","[Kategori ikke funnet - Ut]");
        byttKategori("2018-09-11","10.09 PANDURO SANDAKERVN 3 OSLO","[Kategori ikke funnet - Ut]");
        byttKategori("2018-09-11","10.09 BLG SANDAKER SE SANDAKERVEIE OSLO","[Kategori ikke funnet - Ut]");
        byttKategori("2018-09-21","*1686 18.09 NOK 5.00 Vipps *Engebraaten Bo Kurs: 1.0000","[Kategori ikke funnet - Ut]");
    ...
    private void byttKategori(String datoString, String tekstFraBankenString, String tittelNyKategoriString) {
        LocalDate dato = Datokyklop.hent().opprettDatoSomYYYY_MM_DD(datoString);
        if (dato == null) {
            Loggekyklop.bruk().loggADVARSEL("Klarte ikke å konvertere datoString " + datoString + ", avbryter oppdatering.");
            return;
    ...
    private void byttkategoriAlle(String datoString, String tekstFraBankenString, String tittelNyKategoriString) {
        LocalDate dato = Datokyklop.hent().opprettDatoSomYYYY_MM_DD(datoString);
        if (dato == null) {
            Loggekyklop.bruk().loggADVARSEL("Klarte ikke å konvertere datoString " + datoString + ", avbryter oppdatering.");
            return;
